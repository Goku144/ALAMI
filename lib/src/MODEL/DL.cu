...
#else
  this->io = new HANDLER::IO(*this->cpu);
#endif
...
void MODEL::DL::initializeOperators()
{
  ...
  this->fc1Op = new OPERATOR::MatrixMulBias(*this->workspace);
...
void MODEL::DL::setActiveBatch(size_t batch)
{
  ...
  this->convOp->setOperand(this->z0, this->x, this->w0, this->b0);
  this->poolOp->setOperand(this->p, this->a0);
  this->fc2Op->setOperand(this->z2, this->a1, this->w2, this->b2);
  this->softmaxOp->setOperand(this->out, this->z2);
}
...
void MODEL::DL::forward(size_t batchOffset, size_t batch)
{
  ...
  this->fc1Op->setOperand(this->z1, this->p, this->w1, this->b1);
