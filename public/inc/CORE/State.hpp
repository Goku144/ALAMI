...
namespace CORE
{
  ...
  enum errIO
  {
    ...
    ioErrOutOfMemory = 0x01 << 2,
    ioErrOutOfBound = 0x01 << 3,
    ioErrNull = 0x01 << 4,
    ioErrInvalidValue = 0x01 << 5,
    ioErrInvalidState = 0x01 << 6,
#if CUDA_CPU == 1
    ioErrCopyToDevice = 0x01 << 7,
#endif
  };
  ...
  enum errWorkspace
  {
    ...
    workspaceErrScratchAlloc = 0x01 << 1,
    workspaceErrScratchFree = 0x01 << 2,
    workspaceErrScratchOutOfBound = 0x01 << 3,
    workspaceErrNull = 0x01 << 4,
#if CUDA_CPU == 1
    workspaceErrCudaStreamCreate = 0x01 << 5,
    workspaceErrCudaStreamDestroy = 0x01 << 6,
    workspaceErrCudnnSetStream = 0x01 << 7,
    workspaceErrCudnnCreate = 0x01 << 8,
    workspaceErrCudnnDestroy = 0x01 << 9,
    workspaceErrCublasLtCreate = 0x01 << 10,
    workspaceErrCublasLtDestroy = 0x01 << 11,
#else
    workspaceErrDnnlEngineCreate = 0x01 << 5,
    workspaceErrDnnlEngineDestroy = 0x01 << 6,
    workspaceErrDnnlStreamCreate = 0x01 << 7,
    workspaceErrDnnlStreamDestroy = 0x01 << 8,
#endif
  };
