...
#else
  dnnl_memory_desc_t xDesc;
  dnnl_memory_desc_t wDesc;
  dnnl_memory_desc_t yDesc;
  dnnl_memory_desc_t biasDesc;
  dnnl_primitive_desc_t convPd;
  dnnl_primitive_t convPrimitive;
#endif
  int padH;
  int padW;
  int strideH;
